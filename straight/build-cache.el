...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2020-04-04 16:39:09" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2020-04-04 16:39:09" nil (:local-repo nil :package "org-elpa" :type git)) "org-roam" ("2020-04-04 16:39:12" ("emacs" "dash" "f" "s" "async") (:host github :repo "jethrokuan/org-roam" :branch "develop" :package "org-roam" :type git :local-repo "org-roam")) "melpa" ("2020-04-04 16:39:09" nil (:type git :host github :repo "melpa/melpa" :no-build t :package "melpa" :local-repo "melpa")) "dash" ("2020-04-04 16:39:12" nil (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "f" ("2020-04-04 16:39:12" ("s" "dash") (:type git :flavor melpa :files ("f.el" "f-pkg.el") :host github :repo "rejeep/f.el" :package "f" :local-repo "f.el")) "s" ("2020-04-04 16:39:12" nil (:type git :flavor melpa :files ("s.el" "s-pkg.el") :host github :repo "magnars/s.el" :package "s" :local-repo "s.el")) "async" ("2020-04-04 16:39:12" ("emacs") (:type git :flavor melpa :host github :repo "jwiegley/emacs-async" :package "async" :local-repo "emacs-async"))))
...
(fn &optional ARG)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "dired-async" (quote ("dired-async-")))) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "smtpmail-async" (quote ("async-smtpmail-")))) (provide (quote async-autoloads))) "org-roam" ((org-roam-autoloads org-roam-utils org-roam) (autoload (quote org-roam-mode) "org-roam" "Global minor mode to automatically update the org-roam buffer.

(fn &optional ARG)" t nil) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "org-roam" (quote ("org-roam")))) (if (fboundp (quote register-definition-prefixes)) (register-definition-prefixes "org-roam-utils" (quote ("org-roam--")))) (provide (quote org-roam-autoloads)))))
